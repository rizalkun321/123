...
const apibarbar = 'RAMLANGANS'; // APIKEY MHANKBARBAR
const tobzkey = 'BotWeA'; // APIKEY TOBZ
const vinzkey = 'apivinz'; // APIKEY ZEKS
const BotName = 'ZeroTwo'; // GANTI PAKE NAMA BOT LU
const wa = 'https://chat.whatsapp.com/FyH5iI2VO6mCltkDBHw7gq'; // LINK GRUP WA JANGAN DIGANTI YA BIAR KUMPUL DISITU SALING MENGENAL:)
const ow = 'RIZ'; // GANTI PAKE NAMA MU
const nomorowner = '085894628645'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = 'Belum punya'; // GANTI PAKE NOMOR OVO LU
const pulsa = 'belum punya'; // GANTI PAKE NOMOR PULSA LU
const dana = 'belum punya'; // GANTI PAKE NOMOR DANA LU
const gopay = 'belum punya'; // GANTI PAKE NOMOR GOPAY LU
const instagram = 'http://www.instagram.com/punya_rizal'; // GANTI IG LU
...
conn.on('qr', qr => {
  ...
  console.log(`[ ${moment().format("HH:mm:ss")} ] SUBSCRIBE YT RIZ CHANNEL!`);
});
...
//CREATOR
    ...
    conn.sendMessage(id, `Nih ownerku hehee😁 jangan di galakin ya:*`, MessageType.text, { quoted: m })
  }
//DONASI
...
2. *!nulis*
➸ Untuk membuat tulisan | contoh : !nulis Riz baik hati dan sopan
3. *!stalkig*
➸ Untul stalking ig menggunakan username | contoh : !stalkig iamRiz_
4. *!ssweb*
➸ Mengambil gambar web | contoh : !ssweb http://xnxx.com
5. *!quotes*
➸ Random quotes
6. *!bikinquote*
➸ Untuk membuat quotes gambar | contoh : !bikinquote percuma cantik kalo hasil open bo & Kata Riz
7. *!ytmp3*
...
13.️ *!artinama*
➸ primbon nama kalian | contoh : !artinama Riz
14. *!artijodoh*
➸ primbon jodoh | contoh : !artijodoh Naruto & Hinata
15. *!artimimpi*
...
24. *!pornhub*
➸ Jika undefined berarti harus pake 2 text | contoh : !pornhub Riz & Gans
25. *!hartatahta*
...
// IKLAN
  if (text.includes('!ismismismidsmdismdisdsdk')) {
    var nomor = m.participant
    const options = {
      text: `*Hallo @${nomor.split("@s.whatsapp.net")[0]} I'm ${BotName}*
         ────────────────
...
//YT MP3
  if (text.includes('!ytmp3')) {
    ...
    axios.get(`https://ohto-ai.herokuapp.com/ytmus?URL=${teks}`).then((res) => {
